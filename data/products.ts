...
export const PRODUCTS: Product[] = [
    ...
    // Natura
    { id: 'n1', name: 'Hidratante Tododia Noz Pecã e Cacau - 400ml', brand: 'natura' },
    { id: 'n2', name: 'Essencial Exclusivo Feminino Deo Parfum 100ml', brand: 'natura' },
    { id: 'n3', name: 'Kaiak Masculino Desodorante Colônia 100ml', brand: 'natura' },
    { id: 'n4', name: 'Ekos Castanha Polpa Hidratante para Mãos 75g', brand: 'natura' },

    // Tupperware
    { id: 't1', name: 'Eco Tupper Garrafa 500ml - Diversas Cores', brand: 'tupperware' },
    { id: 't2', name: 'Jeitosinho 400ml - Organizador de Freezer', brand: 'tupperware' },
